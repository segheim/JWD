...
public class SurfaceAreaTetrahedronTest {
    ...
    @DataProvider(name = "DataCheckSurfaceAreaTetrahedron")
    public Object[][] checkSurfaceAreaTest(){
        return new Object[][]{{84, tetrahedron},
                {89, tetrahedron1},
                {65, tetrahedron2},
                {121, tetrahedron3}
        };
